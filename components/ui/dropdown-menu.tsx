...
// Define local types for props that Radix doesn't export
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.Trigger
    ...
    className={cn(
      ...
      "disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-accent data-[state=open]:text-accent-foreground",
      className
    )}
    {...props}
  >
...
>(({ className, sideOffset = 4, children, ...props }, ref) => {
  const contentClass = React.useMemo(() => cn(
...
>(({ className, ...props }, ref) => {
  const subContentClass = React.useMemo(() => cn(
...
// Export local types for external use
export type {
